...
#from technologybutton import technologybutton


class technology(QDialog):
    '''
    The technologybutton dialog
    '''
    
    def __init__(self):
        super().__init__()
        self.ui = uic.loadUi('technology.ui')
...
# ----------------------------------------------------------------------------------------------
    ...
    def _update_graph3(self):
        ...
        where category_name = "Technology") as sales_fact JOIN customer_dim cd ON sales_fact.customerkey = cd.customerkey
        ...
        title = (" Top Websites selling Tech Products ")
